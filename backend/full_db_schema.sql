...
-- Insert Department for Employee
INSERT IGNORE INTO `departments` (`id`, `name`, `description`, `status`, `created_at`, `updated_at`) VALUES ('69e828ca-511a-4fdb-9a16-3bcb25585321', 'Sales', 'General Sales Department', 'active', NOW(), NOW());

-- Insert Default Admin Master User
INSERT IGNORE INTO `employees` (`id`, `name`, `email`, `phone`, `password`, `isMaster`, `status`, `created_at`, `updated_at`) VALUES ('724e5f45-0371-4d83-9234-b9d7026763ed', 'Master Admin', 'admin@hir.com', '1234567890', 'admin123', 1, 'active', NOW(), NOW());

-- Insert Regular Employee
INSERT IGNORE INTO `employees` (`id`, `name`, `email`, `phone`, `password`, `departmentId`, `isMaster`, `status`, `created_at`, `updated_at`) VALUES ('6419030b-e53b-47ae-9e67-5ca8d33d9958', 'Test Employee', 'employee@hir.com', '0987654321', 'emp123', '69e828ca-511a-4fdb-9a16-3bcb25585321', 0, 'active', NOW(), NOW());
